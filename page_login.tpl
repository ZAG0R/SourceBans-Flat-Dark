		...
		<td class="listtable_1" style="padding: 15px;">
	        <div id="login-content">
		        ...
		        <div id="loginRememberMeDiv">
	    	        <input id="loginRememberMe" type="checkbox" class="checkbox" name="remember" value="checked" vspace="5px" />    <span class="checkbox" style="cursor:pointer;" onclick="($('loginRememberMe').checked?$('loginRememberMe').checked=false:$('loginRememberMe').checked=true)">Beni Hatırla</span>
  		        </div>
		
  		        <div id="loginSubmit">	
					<center><a href="steamopenid.php"><img src="images/steamlogin.png"></a></center>
					<br>
			        -{sb_button text="Giriş Yap" onclick=$redir class="ok login" id="alogin" style="width: 100%; text-transform: uppercase;" submit=false}-
		        </div>
		
		        <div id="loginOtherlinks">
			        <a href="index.php?p=lostpassword">Şifreni mi Unuttun ?</a>
		        </div>
	        </div>
        </td>
    </tr>
