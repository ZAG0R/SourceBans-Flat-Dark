...
{else}
<h3 align="left">Toplam Yasak Sayısı:  <font color="#2C3E50" weight="bold"><u>{$total_bans}</u></font></h3>
<br />
...
<div id="banlist">
	<table width="100%" cellspacing="0" cellpadding="0" align="center" class="listtable">
		<tr>			
			<td width="8%" height="16" class="listtable_top" align="center"><b>MOD/TİP</b></td>
			<td width="14%" height="16" class="listtable_top" align="center"><b>TARİH</b></td>
			<td height="16" class="listtable_top"><b>OYUNCU</b></td>
			{if !$hideadminname}
			<td width="12%" height="16" class="listtable_top"><b>Admin</b></td>
			{/if}
			<td width="16%" height="16" class="listtable_top" align="center"><b>SÜRE</b></td>
		</tr>
        ...
        <td height="16" class="listtable_1">
          ...
          {if empty($ban.player)}
            <i><font color="#677882">Kullanıcı Nicki Girilmemiş</font></i>
          {else}
        ...
        <td colspan="7" align="center">
          <div class="opener"> 
              ...
              <tr align="left">
                <td width="20%" height="16" class="listtable_1">Oyuncu</td>
                <td height="16" class="listtable_1">
                  {if empty($ban.player)}
                    <i><font color="#677882">Girilmemiş</font></i>
                  {else}
                    {$ban.player|escape:'html'|stripslashes}
                  {/if}
                </td>
              ...
              <tr align="left">
                ...
                <tr align="left">
					        ...
					        <tr align="left">
					            <td width="20%" height="16" class="listtable_1">Yasak Süresi</td>
							...
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Yasak Sebebi</td>
								<td height="16" class="listtable_1">{$ban.reason|escape:'html'}</td>
							</tr>
							{if !$hideadminname}
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Yasaklayan Admin</td>
								<td height="16" class="listtable_1">
									{if !empty($ban.admin)}
										{$ban.admin|escape:'html'}
									{else}
							...
							{/if}
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Yasaklandığı Sunucu</td>
							...
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Toplam Yasak</td>
