<div align="center">
	<table width="50%" cellpadding="0" class="listtable" cellspacing="0">
		<tr class="sea_open">
			<td width="2%" height="16" class="listtable_top" colspan="3" style="text-align: center;"><b>Gelişmiş Arama</b></td>
	  	</tr>
	  	<tr>
	  		<td>
	  		<div class="panel">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" width="26%">Nick</td>
								...
								<td>
									<select class="select" id="length" onmouseup="$('length_').checked = true" onchange="switch_length(this);" onmouseover="if(this.options[this.selectedIndex].value=='other')$('length').setStyle('width', '210px');if(this.options[this.selectedIndex].value=='other')this.focus();" onblur="if(this.options[this.selectedIndex].value=='other')$('length').setStyle('width', '20px');" style="width: 127%;">
										...
										<optgroup label="days">
											...
											<option value="8640">6 gün</option>
										</optgroup>
										<optgroup label="weeks">
											<option value="10080">1 hafta</option>
											<option value="20160">2 hafta</option>
											<option value="30240">3 hafta</option>
										</optgroup>
										<optgroup label="months">
											<option value="40320">1 ay</option>
											<option value="80640">2 ay</option>
											<option value="120960">3 ay</option>
											<option value="241920">6 ay</option>
											<option value="483840">12 ay</option>
										</optgroup>
										<option value="other">Spesifik Zaman Gir</option>
									</select>
								</td>
							</tr>
						</table>
				...
				{/if}
			    <tr>
			        <td colspan="4">{sb_button text="Ara" onclick="search_bans();" class="ok searchbtn" id="searchbtn" submit=false}</td>
			    </tr>
			   </table>
			   </div>
		  </td>
