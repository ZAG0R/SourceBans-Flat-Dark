	...
	<ul>
		{if $access_admins}
			<li>
				...
				<img src="themes/default/images/admin/admins.png" alt="Admin Settings" border="0" style="width: 48px; height: 48px"/><br />
				Admin Ayarları
		  		</a>
			</li>
		{/if}
		{if $access_servers}
			<li>
				...
				<img src="themes/default/images/admin/servers.png" alt="Server Admin" border="0" style="width: 48px; height: 48px"/><br />
				Server Ayarları
		  		</a>
			</li>
		{/if}
		{if $access_bans}
			<li>
				...
				<img src="themes/default/images/admin/bans.png" alt="Edit Bans" border="0" style="width: 48px; height: 48px"/><br />
				Banlar
		  		</a>
			</li>
		{/if}
		{if $access_groups}
			<li>
				...
				<img src="themes/default/images/admin/groups.png" alt="Edit Groups" border="0" style="width: 48px; height: 48px"/><br />
				Group Ayarları
		  		</a>
			</li>
		{/if}
		{if $access_settings}
			<li>
				...
				<img src="themes/default/images/admin/settings.png" alt="SourceBans Settings" border="0" style="width: 48px; height: 48px"/><br />
				Webpanel Ayarları
		  		</a> 
			</li>
		{/if}
		{if $access_mods}
			<li>
				...
				<img src="themes/default/images/admin/mods.png" alt="Mods" border="0" style="width: 48px; height: 48px"/><br />
				Modları Düzenle
		  		</a>
			</li>
		{/if}
